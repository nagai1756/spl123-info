...
@Component({
  selector: 'app-pages',
  templateUrl: './spl1.component.html',
  styleUrls: ['./spl1.component.scss']
})
export class Spl1Component {
  data!: Observable<any>
  weaponDataAll = []
  weaponData = []
  weapons = []
  ...
  ngOnInit(): void {
    this.dataService.selectedVersion = 'spl1'
    this.dataService.selectedType = '全て'
    this.dataService.color = 'accent'
